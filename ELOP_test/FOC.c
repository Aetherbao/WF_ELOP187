...
uint8 u8_Interface_HWVersion[10] = {'Y', '2', 'E', 'O', 'P',
                                    'H', 'H', 'W', '1', '0'};
static uint8 u8_Interface_SysName[7] = {'E', 'L', 'O', 'P', '1', '8', '7'};
static uint8 u8_Interface_SWVersion[10] = {'Y', '2', 'P', 'S', '0',
                                           '0', '3', '.', '0', '7'};
static uint8 u8_Interface_DataVersion[25] = {
...
uint8 Gu8_ComIf_SleepReqFlag;
uint8 Gu8_ComIf_APPRxMsgData[8];
uint8 Gu8_ComIf_APPTxMesFlagSecond;
uint8 Gu8_DIAG_HSLS_OCWarning;
uint8 Gu8_ComIf_APPTxMesFlagFirst;
...
void Interface_DcycGen_FstTask_Trans(void) {
  ...
  busDcycGen_FstTaskIn.u16_phiActElecAg =
      busPhVltgGen_MedTaskOut.u16_phiActElecAg;
  busDcycGen_FstTaskIn.u16_phiDaxQaxVltgAg =
      busPhVltgGen_MedTaskOut.u16_phiDaxQaxVltgAg;
  busDcycGen_FstTaskIn.enm_stMotoSt = busPhCurrGen_SlwTaskOut.enm_stMotoSt;
  busDcycGen_FstTaskIn.s16_nPredActElecSpd =
...
void Interface_SigIn_MedTask_Trans(void) {
  ...
  //	{
  u16_SchM_AgMech =
      (0xFFFF - (uint16_t)((0x7FFF & Gu16_PSCD_AngleData_IF) << 1));
  //	}
  //	else
  //	{
  //	  u16_SchM_AgMech = (0xFFFF - (uint16_t)(
  //                  ((uint32_t)((0x7FFF & Gu16_PSCD_AngleData_IF)<<1) +
  //                  (uint32_t)u16_AgADOffset)
  //                              & 0x0000FFFF) );
  //	}
  //   Sys_IntEnIrq();
...
void Interface_PhVltgGen_MedTask_Trans(void) {
  ...
  busPhVltgGen_MedTaskIn.s16_iRefDaxQaxCurr[0] =
      busPhCurrGen_SlwTaskOut.s16_iRefDaxQaxCurr[0];
  busPhVltgGen_MedTaskIn.s16_iRefDaxQaxCurr[1] =
      busPhCurrGen_SlwTaskOut.s16_iRefDaxQaxCurr[1];
  busPhVltgGen_MedTaskIn.s16_iActPhCurr[0] =
      busSigIn_MedTaskOut.s16_iActPhCurr[0];
  busPhVltgGen_MedTaskIn.s16_iActPhCurr[1] =
      busSigIn_MedTaskOut.s16_iActPhCurr[1];
  busPhVltgGen_MedTaskIn.s16_iActPhCurr[2] =
  ...
  busPhVltgGen_MedTaskIn.u16_phiModulActElecAg =
      busDcycGen_FstTaskOut.u16_phiModulActElecAg;
  busPhVltgGen_MedTaskIn.u16_phiPosSCDCalibElecAg =
      busAST_SlwTaskOut.u16_phiPosSCDCalibElecAg;
  busPhVltgGen_MedTaskIn.u16_dcycPhDyc[0] =
      busDcycGen_FstTaskOut.u16_dcycPhDyc[0];
  busPhVltgGen_MedTaskIn.u16_dcycPhDyc[1] =
      busDcycGen_FstTaskOut.u16_dcycPhDyc[1];
  busPhVltgGen_MedTaskIn.u16_dcycPhDyc[2] =
      busDcycGen_FstTaskOut.u16_dcycPhDyc[2];
  busPhVltgGen_MedTaskIn.bol_enPosSCDCalibEnFlg = !bol_flgCalibFin;
  busPhVltgGen_MedTaskIn.enm_modeAgEvalMode =
      busAST_SlwTaskOut.enm_modeAgEvalMode;
  busPhVltgGen_MedTaskIn.s16_nRmpRefElecSpd =
  ...
  busPhVltgGen_MedTaskIn.u16_ampMaxNrmVltgAmp =
      busDcycGen_FstTaskOut.u16_ampMaxNrmVltgAmp;
  //    busPhVltgGen_MedTaskIn.s16_uRefDaxVltgLim =
  //    busAST_SlwTaskOut.s16_uRefDaxVltgLim;
  //    busPhVltgGen_MedTaskIn.u16_ampMaxVltgAmp =
  //    busAST_SlwTaskOut.u16_ampMaxVltgAmp;
  //    busPhVltgGen_MedTaskIn.s16_uRefQaxVltgLim =
  //    busAST_SlwTaskOut.s16_uRefQaxVltgLim;
  //		Sys_IntEnIrq();
}

void Interface_PhCurrGen_SlwTask_Trans(void) {
  busPhCurrGen_SlwTaskIn.s16_nRefElecSpd = busAST_SlwTaskOut.s16_nRefElecSpd;
  busPhCurrGen_SlwTaskIn.s16_nActElecSpd =
      busPhVltgGen_MedTaskOut.s16_nActElecSpd;
  busPhCurrGen_SlwTaskIn.s16_nRmpRefElecSpd =
      busAST_SlwTaskOut.s16_nRmpRefElecSpd;
  ...
  busPhCurrGen_SlwTaskIn.s16_trqPosSCDCalibRefTq =
      busAST_SlwTaskOut.s16_trqPosSCDCalibRefTq;
  busPhCurrGen_SlwTaskIn.enm_modeAgEvalMode =
      busAST_SlwTaskOut.enm_modeAgEvalMode;
  busPhCurrGen_SlwTaskIn.s16_phiOpnLpAgClsLpAgDvt =
...
void Interface_AST_SlwTask_Trans(void) {
  ...
  busAST_SlwTaskIn.u16_phiSensActElecAg =
      busSigIn_MedTaskOut.u16_phiSensActElecAg;
  ...
  //  busAST_SlwTaskIn.u16_ampMaxNrmVltgAmp =
  //  busDcycGen_FstTaskOut.u16_ampMaxNrmVltgAmp;
  //  busAST_SlwTaskIn.s16_uRefDaxVltg =
  //  busPhVltgGen_MedTaskOut.s16_uRefDaxVltg;
  busAST_SlwTaskIn.bol_flgPhiSensFaltRawFlg =
      busOBD_SlwTaskOut.bol_flgPhiSensFaltRawFlg;
...
void Interface_OBD_SlwTask_Trans(void) {
  ...
  // Gu8_ComIf_APPRxMesCnt;//bol_ComIf_flgComLosFaltRaw;   1ms-task
  ...
  busOBD_SlwTaskIn.bol_flgChipFalt = ((Gu16_BSWToAPPFault_IF & 0x01) >> 0) ||
                                     ((Gu16_BSWToAPPFault_IF & 0x02) >> 1);
  ...
  busOBD_SlwTaskIn.s16_iRefDaxQaxCurr[0] =
      busPhCurrGen_SlwTaskOut.s16_iRefDaxQaxCurr[0];
  busOBD_SlwTaskIn.s16_iRefDaxQaxCurr[1] =
      busPhCurrGen_SlwTaskOut.s16_iRefDaxQaxCurr[1];
  busOBD_SlwTaskIn.s16_iActDaxQaxCurr[0] =
      busPhVltgGen_MedTaskOut.s16_iActDaxQaxCurr[0];
  busOBD_SlwTaskIn.s16_iActDaxQaxCurr[1] =
      busPhVltgGen_MedTaskOut.s16_iActDaxQaxCurr[1];
  ...
  busOBD_SlwTaskIn.u16_psiEstPermMagFlx =
  ...
  busOBD_SlwTaskIn.bol_flgMosOpnCirFalt =
      (Gu16_BSWToAPPFault_IF & 0x40) >> 6; // Temp_FaultFlg;//false;
  // busOBD_SlwTaskIn.bol_ComIf_flgComLosFaltRaw =
  // Gu8_ComIf_APPRxMesCnt;//bol_ComIf_flgComLosFaltRaw;  no use
}
...
void Interface_ApplCom_ASW_Trans(void) {
  ...
  if (MCUF_CRCCheck_27A ==
      Interface_crc_high_first(&Gu8_ComIf_APPRxMsgData[0], 7)) {
  ...
  if (bol_ComIf_flgCRCFaltRaw == false) {
    ...
    MCUF_PumpMotorSpeedReq = (Gu8_ComIf_APPRxMsgData[1] & 0xFF) |
                             ((Gu8_ComIf_APPRxMsgData[2] & 0x1F) << 8);
    s16_ComIf_nComRefMechSpd =
        (sint16)((sint32)(MCUF_PumpMotorSpeedReq << 15) / Cdbl_nMechSpdPeakVal);
    ...
    if ((s16_ComIf_nComRefMechSpd != 0) && (s16_ComIf_nComRefMechSpd < 250)) {
      ...
      s16_ComIf_nComRefMechSpd =
          (sint16)((sint32)(s16_ComIf_nComRefMechSpd * 107) / 100);
    }
  ...
  if (Gu8_ComIf_APPTxMesFlagSecond == true) {
    ...
    u8_ComIf_APPTxMsgData1[0] =
        ...
        (((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgHWOvrCurrFlg &
           (bol_flgHWOvrCurrComEn))
          << 5) &
         0x20) |
        (((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgComFaltFlg &
           busOBD_SlwTaskOut.bol_flgComNodeLosFaltDeb)
          << 6) &
         0x40) |
        ((busOBD_SlwTaskOut.bol_flgPhiSensFaltRawFlg << 7) & 0x80);
    u8_ComIf_APPTxMsgData1[1] =
        (busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgPwrTubPCBTempHiLvl2Flg & 0x01) |
        ((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgGDVltgHiLvl1Flg << 2) & 0x04) |
        ((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgSplyVltgHiLvl1Flg << 3) &
         0x08) |
        ((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgGDVltgLoLvl1Flg << 4) & 0x10) |
        ((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgSplyVltgLoLvl2Flg << 5) &
         0x20) |
        ((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgMotoSpdLoLvl1Flg << 7) & 0x80);
    ComIf_BusCurrent =
        (sint16)((sint32)((sint32)(busAST_SlwTaskOut.s16_iEstSplyCurr) *
                          Cdbl_iSplyCurrPeakVal * 10) >>
                 15);
    ...
    } else if ((busAST_SlwTaskOut.enm_stSysSt == RUN) &&
    ...
    u8_ComIf_APPTxMsgData1[3] =
        ((ComIf_BusCurrent >> 8) & 0x03) |
        (((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgComFaltFlg &
           busOBD_SlwTaskOut.bol_flgComRolCntFaltDeb)
          << 2) &
         0x04) |
        (((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgComFaltFlg &
           busOBD_SlwTaskOut.bol_flgCRCFaltDeb)
          << 3) &
         0x08) |
        ((ComIf_RunningStatus << 4) & 0xF0);
    if (MCUF_OperationModel == 0 &&
        !busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgComFaltFlg) {
      ComIf_OffCmdRecFb = 1;
    } else {
      ComIf_OffCmdRecFb = 0;
    }
    u8_ComIf_APPTxMsgData1[4] =
        (ComIf_OffCmdRecFb & 0x01) | ((u16_Interface_AplHWVer << 4) & 0xF0);
    ComIf_PhaseCurrent =
        (sint16)((sint32)((sint32)(busAST_SlwTaskOut.s16_ampActPhCurrAmp) *
                          Cdbl_iPhCurrPeakVal * 10) >>
                 15);
    ...
    u8_ComIf_APPTxMsgData1[6] =
        ((ComIf_AlvCnt1 << 4) & 0xF0) | ((ComIf_PhaseCurrent >> 7) & 0x0F);
    u8_ComIf_APPTxMsgData1[7] =
        Interface_crc_high_first(&u8_ComIf_APPTxMsgData1[0], 7);
    // ComIf_Set_APPTxMsgData(u8_ComIf_APPTxMsgData1,0x1F);
  }

  /* Send Application message 0x20 */
  Gs16_ComIf_ActSpdBOOTChk =
      (sint16)((sint32)((sint32)(busAST_SlwTaskOut.s16_nActElecSpdComFlt) *
                        7827) >>
               15);
  if (Gu8_ComIf_APPTxMesFlagFirst == true) {
    Gu8_ComIf_APPTxMesFlagFirst = 0;
    u8_ComIf_APPTxMsgData2[0] = (uint8)(Gu8_tMcuTemp_IF + 10) & 0xFF;
    u8_ComIf_APPTxMsgData2[1] =
        (uint8)(busSigIn_SlwTaskOut.u8_tPCBTemp + 10) & 0xFF;
    u8_ComIf_APPTxMsgData2[2] =
        (uint8)((sint32)((sint32)(busSigIn_MedTaskOut.u16_uSplyVltg) *
                         Cdbl_uSplyVltgPeakVal * 5) >>
                15) &
        0xFF;
    if ((busPhCurrGen_SlwTaskOut.enm_stMotoSt != OFF) &&
        (busPhVltgGen_MedTaskOut.s16_nActElecSpd > 0)) {
      /* ComIf_ActualSpeed =
       * (busPhVltgGen_MedTaskOut.s16_nActElecSpd*Cdbl_nElecAgSpdPeakVal*6/PI)>>15
       */
      //	ComIf_ActualSpeed =
      //(sint16)((sint32)((sint32)(busPhVltgGen_MedTaskOut.s16_nActElecSpd)*7827)>>15);
      ComIf_ActualSpeed =
          (sint16)((sint32)((sint32)(busAST_SlwTaskOut.s16_nActElecSpdComFlt) *
                            7827) >>
                   15);
    ...
    u8_ComIf_APPTxMsgData2[4] =
        ((Gs16_Interface_ActSpd >> 8) & 0x1F) |
        ((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgPwrTubPCBTempSensFaltFlg
          << 5) &
         0x20) |
        (((busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgChipFaltFlg |
           busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgMosOpnCirFaltFlg)
          << 7) &
         0x80);
    u8_ComIf_APPTxMsgData2[5] =
        ((u16_Interface_AplSWVer << 2) & 0xFC) | (u8_Interface_SplyID & 0x03);
    ...
    u8_ComIf_APPTxMsgData2[7] =
        Interface_crc_high_first(&u8_ComIf_APPTxMsgData2[0], 7);
    // ComIf_Set_APPTxMsgData(u8_ComIf_APPTxMsgData2,0x20);
...
void Interface_FrzUDSCom_ASW_Trans(void) {
  ...
  {
                  busComIf_UDSRead_In.u8_SysName[u8_NumSysName] =
u8_Interface_SysName[u8_NumSysName];
  }
for(u8_NumSWVersion = 0;u8_NumSWVersion < 10;u8_NumSWVersion++)
  {
busComIf_UDSRead_In.u8_WF_SWVersion[u8_NumSWVersion] =
u8_Interface_SWVersion[u8_NumSWVersion];
  }
  for(u8_NumDataVersion = 0;u8_NumDataVersion < 25;u8_NumDataVersion++)
  {
busComIf_UDSRead_In.u8_CalibDataVersion[u8_NumDataVersion] =
u8_Interface_DataVersion[u8_NumDataVersion];
  }
  for(u8_NumHWVersion = 0;u8_NumHWVersion < 10;u8_NumHWVersion++)
  {
  busComIf_UDSRead_In.u8_WF_HWVersion[u8_NumHWVersion] =
u8_Interface_HWVersion[u8_NumHWVersion];
  }*/
}
...
void Interface_AgCalib_Trans(void) {
  ...
  case 0: // INIT
  {
     ...
     * All Data stored in NVM would be copy to ram by 'Mem_DataNVM2RAM()' at
     * first
     */
  ...
  case 1: // CALIBRATION
  {
    if ((bol_flgPosSCDCalibSucFlgOld == false) &&
      ...
      /**This palce should make 'u16_AgADOffset' at MEM_CHARACT_DATA_RAM section
       * which use 'MEM_CHARACT_DATA_RAM', and call function
       * 'Mem_DataRAM2NVM(MEM_CHARACT_DATA)', can store data to NVM
       * */
      // Sys_IntDisIrq();
...
void Interface_Mem_Trans(void) {
  ...
  for (NumWF_HWVersion = 0; NumWF_HWVersion < 10; NumWF_HWVersion++) {
    u8_Interface_HWVersion[NumWF_HWVersion] =
        Gu8_ComIf_HWVersion[NumWF_HWVersion];
  }
...
void Print_10ms(int count) {
  ...
  fprintf(log_file, "when Gu16_uADCVDH_IF=%d,u16_uSplyVltg=%d\n",
          Gu16_uADCVDH_IF, busSigIn_MedTaskOut.u16_uSplyVltg);
  fprintf(log_file, "when Gu8_tMcuTemp_IF=%d,u8_tPCBTempSubs:%d\n",
          Gu8_tMcuTemp_IF, busSigIn_SlwTaskOut.u8_tPCBTempSubs);
  fprintf(log_file,
          "u8_tPwrTubTemp:%d; u16_uCtlBrdVltg:%d; u16_uGDVltg:%d; u8_tMotoTemp="
          "%d\n",
          busSigIn_SlwTaskOut.u8_tPwrTubTemp,
          busSigIn_SlwTaskOut.u16_uCtlBrdVltg, busSigIn_SlwTaskOut.u16_uGDVltg,
          busSigIn_SlwTaskOut.u8_tMotoTemp);
  fclose(log_file);
}
...
void test_AST_SlwTask(void) { MCUF_OperationModel = 1; }
...
(busOBD_SlwTaskOut.busOBD_FaltSt.bol_flgComFaltFlg == true)) if
(busAST_SlwTaskOut.enm_stSysSt == SYSSLEEP)
                {
   Sys_SCU_SleepMode();
  }
}*/
