...
//#define LOG_FILE "E:\\02_CompilerWorkSpace\\VSCode\\test\\log.txt"
 ...
 * [EOF]
 */
typedef struct tag_RTM_ASW_AST RT_MODEL_ASW_AST;

typedef struct tag_RTM_ASW_PhCurrGen RT_MODEL_ASW_PhCurrGen;

typedef struct tag_RTM_ASW_PhVltgGen RT_MODEL_ASW_PhVltgGen;

typedef struct tag_RTM_ASW_SigIn RT_MODEL_ASW_SigIn;

typedef struct tag_RTM_ASW_OBD RT_MODEL_ASW_OBD;
