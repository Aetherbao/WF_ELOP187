/*
 * File: look2_is16lu32n16tu16_binlcse.c
 *
...
uint16 look2_is16lu32n16tu16_binlcse(sint16 u0, sint16 u1, const sint16
  ...
  uint32 stride)
{
  ...
  if (u0 <= bp0[0U]) {
    ...
    bpLeftVar = bp0[iLeft];
    frac = (((uint32)((uint16)(u0 - bpLeftVar))) << 16) / ((uint16)
  ...
  if (u1 <= bp1[0U]) {
    ...
    bpLeftVar = bp1[iLeft];
    frac = (((uint32)((uint16)(u1 - bpLeftVar))) << 16) / ((uint16)
