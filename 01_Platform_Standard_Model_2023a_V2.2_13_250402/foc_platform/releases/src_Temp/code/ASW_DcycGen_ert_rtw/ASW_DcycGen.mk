###########################################################################
## Makefile generated for component 'ASW_DcycGen'. 
## 
## Makefile     : ASW_DcycGen.mk
## Generated on : Wed Apr 02 08:52:36 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ASW_DcycGen.exe
...
COMPILER_COMMAND_FILE     = ASW_DcycGen_comp.rsp
CMD_FILE                  = ASW_DcycGen.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ASW_DcycGen.exe
...
DEFINES_STANDARD = -DMODEL=ASW_DcycGen -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ASW_DcycGen_ert_rtw/ASW_DcycGen.c
...
%.obj : $(START_DIR)/ASW_DcycGen_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ASW_DcycGen_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ASW_DcycGen.obj : $(START_DIR)/ASW_DcycGen_ert_rtw/ASW_DcycGen.c
	$(CC) $(CFLAGS) -o "$@" "$<"
