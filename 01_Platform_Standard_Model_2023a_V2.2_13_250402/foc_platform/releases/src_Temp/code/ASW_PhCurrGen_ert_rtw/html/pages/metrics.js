function CodeMetrics() {
	...
	stackTotal: 28};
	 ...
	 return data; }; 
	 this.codeMetricsSummary = '<a href="javascript:void(0)" onclick="return postParentWindowMessage({message:\'gotoReportPage\', pageName:\'ASW_PhCurrGen_metrics\'});">Global Memory: 0(bytes) Maximum Stack: 28(bytes)</a>';
	}
