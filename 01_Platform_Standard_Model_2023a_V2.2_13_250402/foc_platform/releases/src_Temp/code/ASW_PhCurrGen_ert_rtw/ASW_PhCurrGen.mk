###########################################################################
## Makefile generated for component 'ASW_PhCurrGen'. 
## 
## Makefile     : ASW_PhCurrGen.mk
## Generated on : Wed Apr 02 08:52:55 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ASW_PhCurrGen.exe
...
COMPILER_COMMAND_FILE     = ASW_PhCurrGen_comp.rsp
CMD_FILE                  = ASW_PhCurrGen.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ASW_PhCurrGen.exe
...
DEFINES_STANDARD = -DMODEL=ASW_PhCurrGen -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ASW_PhCurrGen_ert_rtw/ASW_PhCurrGen.c
...
%.obj : $(START_DIR)/ASW_PhCurrGen_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ASW_PhCurrGen_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ASW_PhCurrGen.obj : $(START_DIR)/ASW_PhCurrGen_ert_rtw/ASW_PhCurrGen.c
	$(CC) $(CFLAGS) -o "$@" "$<"
