###########################################################################
## Makefile generated for component 'ASW_AST'. 
## 
## Makefile     : ASW_AST.mk
## Generated on : Wed Apr 02 08:52:20 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ASW_AST.exe
...
COMPILER_COMMAND_FILE     = ASW_AST_comp.rsp
CMD_FILE                  = ASW_AST.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ASW_AST.exe
...
DEFINES_STANDARD = -DMODEL=ASW_AST -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ASW_AST_ert_rtw/ASW_AST.c
...
%.obj : $(START_DIR)/ASW_AST_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ASW_AST_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ASW_AST.obj : $(START_DIR)/ASW_AST_ert_rtw/ASW_AST.c
	$(CC) $(CFLAGS) -o "$@" "$<"
