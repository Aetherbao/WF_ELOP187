 ...
 * C/C++ source code generated on : Wed Apr  2 08:53:50 2025
 *
...
void CANSigLosCheck(void)
{
  ...
  if (ASW_OBD_B.bitsForTID1.Equal) {
     ...
     */
    ASW_OBD_B.bitsForTID1.NOT = ((((uint8)(busOBD_SlwTaskIn.u8_ctComRolCnt -
      ASW_OBD_DW.UnitDelay_DSTATE_npzl)) != 1) &&
      ((busOBD_SlwTaskIn.u8_ctComRolCnt != Gu8_RollingMin_C) ||
       (ASW_OBD_DW.UnitDelay_DSTATE_npzl != Gu8_RollingMax_C)));

    /* SignalConversion generated from: '<S70>/bol_flgCRCFaltRaw' incorporates:
     *  Inport: '<Root>/busOBD_SlwTaskIn'
     */
    ASW_OBD_B.bitsForTID1.bol_flgCRCFaltRaw = busOBD_SlwTaskIn.bol_flgCRCFaltRaw;

    /* Update for UnitDelay: '<S73>/Unit Delay' incorporates:
     *  Inport: '<Root>/busOBD_SlwTaskIn'
     */
    ASW_OBD_DW.UnitDelay_DSTATE_npzl = busOBD_SlwTaskIn.u8_ctComRolCnt;
  }
...
void OBD_SlwTask_Init(void)
{
  ...
  /* SystemInitialize for Triggered SubSystem: '<S119>/sss_ComFaltMechSpdRespDefd_GEELY' */
  /* InitializeConditions for UnitDelay: '<S122>/Unit Delay2' */
  ASW_OBD_DW.bitsForTID1.UnitDelay2_DSTATE_i4n0 = true;

  /* End of SystemInitialize for SubSystem: '<S119>/sss_ComFaltMechSpdRespDefd_GEELY' */
}
...
void OBD_SlwTask(void)
{
  ...
  if (rtb_Equal_kjhq) {
    ...
    if (rtb_Selector2_bvc0) {
       ...
       */
      ASW_OBD_lib_Deb_11((ASW_OBD_DW.UnitDelay_DSTATE_bxev ==
                          busOBD_SlwTaskIn.u8_ctLossNoData),
       ...
       */
      ASW_OBD_lib_Deb_11(ASW_OBD_B.bitsForTID1.NOT,
       ...
       */
      ASW_OBD_lib_Deb_11(ASW_OBD_B.bitsForTID1.bol_flgCRCFaltRaw,
       ...
       *  Inport: '<Root>/busOBD_SlwTaskIn'
       */
      ASW_OBD_DW.UnitDelay_DSTATE_bxev = busOBD_SlwTaskIn.u8_ctLossNoData;

      /* Update for UnitDelay: '<S65>/Unit Delay' incorporates:
       *  Inport: '<Root>/busOBD_SlwTaskIn'
       */
      ASW_OBD_DW.UnitDelay_DSTATE_keg4 = busOBD_SlwTaskIn.u8_ctLossNoData;
    }
