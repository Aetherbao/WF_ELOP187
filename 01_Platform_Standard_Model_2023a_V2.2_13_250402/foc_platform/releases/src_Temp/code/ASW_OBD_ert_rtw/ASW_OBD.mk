###########################################################################
## Makefile generated for component 'ASW_OBD'. 
## 
## Makefile     : ASW_OBD.mk
## Generated on : Wed Apr 02 08:54:15 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ASW_OBD.exe
...
COMPILER_COMMAND_FILE     = ASW_OBD_comp.rsp
CMD_FILE                  = ASW_OBD.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ASW_OBD.exe
...
DEFINES_STANDARD = -DMODEL=ASW_OBD -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ASW_OBD_ert_rtw/ASW_OBD.c
...
%.obj : $(START_DIR)/ASW_OBD_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ASW_OBD_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ASW_OBD.obj : $(START_DIR)/ASW_OBD_ert_rtw/ASW_OBD.c
	$(CC) $(CFLAGS) -o "$@" "$<"
