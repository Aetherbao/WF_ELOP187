###########################################################################
## Makefile generated for component 'ASW_PhVltgGen'. 
## 
## Makefile     : ASW_PhVltgGen.mk
## Generated on : Wed Apr 02 08:53:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ASW_PhVltgGen.exe
...
COMPILER_COMMAND_FILE     = ASW_PhVltgGen_comp.rsp
CMD_FILE                  = ASW_PhVltgGen.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ASW_PhVltgGen.exe
...
DEFINES_STANDARD = -DMODEL=ASW_PhVltgGen -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ASW_PhVltgGen_ert_rtw/ASW_PhVltgGen.c
...
%.obj : $(START_DIR)/ASW_PhVltgGen_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ASW_PhVltgGen_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ASW_PhVltgGen.obj : $(START_DIR)/ASW_PhVltgGen_ert_rtw/ASW_PhVltgGen.c
	$(CC) $(CFLAGS) -o "$@" "$<"
