###########################################################################
## Makefile generated for component 'ASW_SigIn'. 
## 
## Makefile     : ASW_SigIn.mk
## Generated on : Wed Apr 02 08:54:31 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ASW_SigIn.exe
...
COMPILER_COMMAND_FILE     = ASW_SigIn_comp.rsp
CMD_FILE                  = ASW_SigIn.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ASW_SigIn.exe
...
DEFINES_STANDARD = -DMODEL=ASW_SigIn -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/ASW_SigIn_ert_rtw/ASW_SigIn.c
...
%.obj : $(START_DIR)/ASW_SigIn_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ASW_SigIn_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ASW_SigIn.obj : $(START_DIR)/ASW_SigIn_ert_rtw/ASW_SigIn.c
	$(CC) $(CFLAGS) -o "$@" "$<"
