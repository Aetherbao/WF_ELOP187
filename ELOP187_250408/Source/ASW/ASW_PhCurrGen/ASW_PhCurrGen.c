 ...
 * C/C++ source code generated on : Tue Apr  1 14:27:17 2025
 *
...
static void rate_scheduler(void)
{
  ...
  if ((ASW_PhCurrGen_M->Timing.TaskCounters.TID[1]) > 79) {/* Sample time: [0.01s, 0.0s] */
...
void PhCurrGen_SlwTask_Init(void)
{
  ...
  /* End of InitializeConditions for S-Function (sfix_udelay): '<S61>/Tapped Delay' */
...
void PhCurrGen_SlwTask(void)
{
  ...
  if (rtb_LogicalOperator) {
    ...
    rtb_Switch1 = mul_ssu32_loSR(((sint16)(rtb_DataTypeConversion2_hrkx +
      (((sint16)((ASW_PhCurrGen_DW.UnitDelay_DSTATE_gwvm -
                  (ASW_PhCurrGen_DW.UnitDelay1_DSTATE_lr2t << 1)) >> 1)) << 1)))
      * 41943, tmp, 6U);
  }
   ...
   */
  /* Gateway: PhCurrGen_SlwTask/vrs_StrtUpRefTqCalc/rss_StrtUpRefTqCalcNeed/sfc_TrqDecre */
  /* During: PhCurrGen_SlwTask/vrs_StrtUpRefTqCalc/rss_StrtUpRefTqCalcNeed/sfc_TrqDecre */
  if (ASW_PhCurrGen_DW.is_active_c2_ASW_PhCurrGen == 0U) {
    /* Entry: PhCurrGen_SlwTask/vrs_StrtUpRefTqCalc/rss_StrtUpRefTqCalcNeed/sfc_TrqDecre */
    ASW_PhCurrGen_DW.is_active_c2_ASW_PhCurrGen = 1U;

    /* Entry Internal: PhCurrGen_SlwTask/vrs_StrtUpRefTqCalc/rss_StrtUpRefTqCalcNeed/sfc_TrqDecre */
    /* Transition: '<S69>:2' */
    ...
    guard1 = false;
    guard2 = false;
    if ((maxV != 0) && ((((rtb_VectorConcatenate_0 <=
                           Gs16_nStrtUpProcTolcElecSpd_C) && (tmp_0 <=
            Gs16_nStrtUpProcTolcElecSpd_C)) && (tmp_1 >= tmp_2)) &&
                        (rtb_enm_stMotoSt == OPEN_LOOP))) {
...
void ASW_PhCurrGen_Init(void)
{
  ...
  (void) memset((void *)ASW_PhCurrGen_M, 0,
                sizeof(RT_MODEL_ASW_PhCurrGen));

  /* block I/O */
  (void) memset(((void *) &ASW_PhCurrGen_B), 0,
                sizeof(B_ASW_PhCurrGen));

  /* exported global signals */
  busPhCurrGen_SlwTaskOut = ASW_PhCurrGen_rtZBUS_PHCURRGEN_SLW_TASK_OUT;

  /* states (dwork) */
  (void) memset((void *)&ASW_PhCurrGen_DW, 0,
                sizeof(DW_ASW_PhCurrGen));
