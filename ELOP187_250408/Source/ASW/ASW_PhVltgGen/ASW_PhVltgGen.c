...
const BUS_PHVLTGGEN_MED_TASK_IN ASW_PhVltgGen_rtZBUS_PHVLTGGEN_ = { { 0, 0 },/* s16_iRefDaxQaxCurr */
...
static void rate_scheduler(void)
{
  ...
  if ((ASW_PhVltgGen_M->Timing.TaskCounters.TID[1]) > 3) {/* Sample time: [0.0005s, 0.0s] */
 ...
 */
void AS_sfc_IntegratorScheduler_Init(boolean *rty_bolIntg1RsetCond, boolean
  *rty_bolIntg2RsetCond, boolean *rty_bolIntg1Ok,
 ...
 *    '<S195>/sfc_IntegratorScheduler'
 */
void ASW_PhV_sfc_IntegratorScheduler(sint16 rtu_mfIntg1Outp, sint16
  rtu_mfIntg2Outp, boolean *rty_bolIntg1RsetCond, boolean *rty_bolIntg2RsetCond,
  boolean *rty_bolIntg1Ok, DW_sfc_IntegratorScheduler_ASW_ *localDW)
{
  sint32 tmp_0;
  sint16 tmp;

  /* Gateway: PhVltgGen_MedTask/vrs_ActElecAgElecSpdCmpt/rss_ActElecAgElecSpdCmptHybr/sss_SenlActElecAgElecSpdEst/lib_FlxObs_0/sss_FluxAlphaBetaEstimation/sss_AlphaMagneticFlux/sfc_IntegratorScheduler */
  if (localDW->temporalCounter_i1 < 511U) {
    localDW->temporalCounter_i1++;
  }

  /* Chart: '<S194>/sfc_IntegratorScheduler' */
  /* During: PhVltgGen_MedTask/vrs_ActElecAgElecSpdCmpt/rss_ActElecAgElecSpdCmptHybr/sss_SenlActElecAgElecSpdEst/lib_FlxObs_0/sss_FluxAlphaBetaEstimation/sss_AlphaMagneticFlux/sfc_IntegratorScheduler */
  if (localDW->is_active_c18_ASW_PhVltgGen == 0U) {
    /* Entry: PhVltgGen_MedTask/vrs_ActElecAgElecSpdCmpt/rss_ActElecAgElecSpdCmptHybr/sss_SenlActElecAgElecSpdEst/lib_FlxObs_0/sss_FluxAlphaBetaEstimation/sss_AlphaMagneticFlux/sfc_IntegratorScheduler */
    localDW->is_active_c18_ASW_PhVltgGen = 1U;

    /* Entry Internal: PhVltgGen_MedTask/vrs_ActElecAgElecSpdCmpt/rss_ActElecAgElecSpdCmptHybr/sss_SenlActElecAgElecSpdEst/lib_FlxObs_0/sss_FluxAlphaBetaEstimation/sss_AlphaMagneticFlux/sfc_IntegratorScheduler */
    /* Transition: '<S205>:7' */
...
void PhVltgGen_MedTask_Init(void)
{
  ...
  AS_sfc_IntegratorScheduler_Init(&rtb_bolIntg1RsetCond_fyi0,
    &rtb_bolIntg2RsetCond_bt4j, &ASW_PhVltgGen_B.bolIntg1Ok_crdb,
    &ASW_PhVltgGen_DW.sf_sfc_IntegratorScheduler);

  /* SystemInitialize for Chart: '<S195>/sfc_IntegratorScheduler' */
  AS_sfc_IntegratorScheduler_Init(&rtb_bolIntg1RsetCond_fyi0,
    &rtb_bolIntg2RsetCond_bt4j, &ASW_PhVltgGen_B.bolIntg1Ok,
...
void PhVltgGen_MedTask(void)
{
  ...
  /* Outputs for Enabled SubSystem: '<S40>/ens_EnOpnLpAgClsLpAgDvtCalc' incorporates:
   ...
   *  Switch: '<S58>/Switch'
   */
  rtb_Sum_cwuo = (sint16)((((rtb_Switch1_kp25 * 20861) >> 4) + (tmp << 15)) >>
    15);
  ...
  switch (busPhVltgGen_MedTaskIn.enm_stMotoSt) {
   case 0:
     ...
     */
    /* SignalConversion generated from: '<S370>/u16_phiActElecAgCs0' incorporates:
   ...
   default:
     ...
     */
    /* SignalConversion generated from: '<S368>/u16_phiActElecAgCsDfl' incorporates:
   ...
   *  Sum: '<S21>/Add'
   */
  rtb_Gain1_mdnf = (dt_Standardize_s16p15b0)((18919 * ((tmp + (tmp_1 << 1)) >> 1))
    >> 14);
   ...
   */
  rtb_DataTypeConversion1_gn4i = (uint16)((((sint16)((Gs16_tiPhVltgAgDel_C *
    (ASW_PhVltgGen_DW.UnitDelay_DSTATE_pwry >> 1)) >> 10)) * 20861) >> 14);
   ...
   *  Sum: '<S33>/Add'
   */
  rtb_Selector1_chuf = rtCP_Constant1_Value[(sint32)((1023U * ((uint16)(16384 -
    rtb_DataTypeConversion1_gn4i))) >> 16)];
   ...
   *  Gain: '<S30>/Gain'
   */
  rtb_Selector1_ngzw = rtCP_Constant_Value_gyri[(sint32)((1023U *
    rtb_DataTypeConversion1_gn4i) >> 16)];
  ...
  rtb_Add_in30 = (dt_Standardize_s16p15b0)(((sint16)((rtb_Product_bnwf *
    rtb_Selector1_chuf) >> 14)) - ((sint16)((rtb_Product1_ccy0 *
    rtb_Selector1_ngzw) >> 14)));
   ...
   */
  ASW_PhV_sfc_IntegratorScheduler(ASW_PhVltgGen_DW.UnitDelay2_DSTATE_iu0k,
   ...
   */
  rtb_Add_d05d = (sint16)((((tmp >> 1) << 3) - ((sint16)((rtb_Gain7 * rtb_Gain2)
    >> 13))) >> 3);
   ...
   */
  rtb_Add1_k5op = (sint16)((((sint16)((rtb_Sum_icq1 * Gu16_facFlxObsFltCoeff_C) >>
    14)) + (((rtb_TmpSignalConversionAtBusC_2 *
              ASW_PhVltgGen_DW.UnitDelay_DSTATE_jl24) >> 15) << 3)) >> 3);
   ...
   */
  rtb_Add1_btax = (sint16)((((sint16)((rtb_Sum_d2gz * Gu16_facFlxObsFltCoeff_C) >>
    14)) + (((rtb_TmpSignalConversionAtBusC_2 *
              ASW_PhVltgGen_DW.UnitDelay_DSTATE_jgqd) >> 15) << 3)) >> 3);
  ...
  if (tmp_0) {
    ...
    rtb_Switch3 = (dt_Standardize_s16p15b0)((17067 * ((sint16)(((tmp << 1) -
      ((sint16)((rtb_Gain2 * rtb_Gain8) >> 13))) >> 1))) >> 15);
  } else {
    rtb_Switch3 = 0;
  }
   ...
   */
  rtb_DataTypeConversion1_jrjz = (uint16)((((sint16)((Gs16_tiSenlElecAgDel_C *
   ...
   *  Sum: '<S192>/Add'
   */
  rtb_Selector1_hkbk = rtCP_Constant1_Value_h4hb[(sint32)((1023U * ((uint16)
    (16384 - rtb_DataTypeConversion1_jrjz))) >> 16)];

  /* Chart: '<S195>/sfc_IntegratorScheduler' incorporates:
   *  UnitDelay: '<S195>/Unit Delay2'
   *  UnitDelay: '<S195>/Unit Delay3'
   */
  ASW_PhV_sfc_IntegratorScheduler(ASW_PhVltgGen_DW.UnitDelay2_DSTATE_fpsd,
  ...
  rtb_Add1_cq0f = (dt_Standardize_s16p15b0)(((sint16)((rtb_Product1_ccy0 *
    rtb_Selector1_chuf) >> 14)) + ((sint16)((rtb_Product_bnwf *
    rtb_Selector1_ngzw) >> 14)));
   ...
   */
  rtb_Add_efob = (sint16)((((tmp >> 1) << 3) - ((sint16)((rtb_Gain7 * rtb_Gain3)
    >> 13))) >> 3);
   ...
   */
  rtb_Add1_mzgk = (sint16)((((sint16)((rtb_Sum_juht * Gu16_facFlxObsFltCoeff_C) >>
    14)) + (((rtb_TmpSignalConversionAtBusC_2 *
              ASW_PhVltgGen_DW.UnitDelay_DSTATE_h5zb) >> 15) << 3)) >> 3);
   ...
   */
  rtb_Add1_bfl0 = (sint16)((((sint16)((rtb_Sum_g2hx * Gu16_facFlxObsFltCoeff_C) >>
    14)) + (((rtb_TmpSignalConversionAtBusC_2 *
              ASW_PhVltgGen_DW.UnitDelay_DSTATE_bffe) >> 15) << 3)) >> 3);
  ...
  if (tmp_0) {
    ...
    rtb_Switch3_eodk = (dt_Standardize_s16p15b0)((17067 * ((sint16)(((tmp << 1)
      - ((sint16)((rtb_Gain3 * rtb_Gain8) >> 13))) >> 1))) >> 15);
  } else {
    rtb_Switch3_eodk = 0;
  }
   ...
   *  Gain: '<S189>/Gain'
   */
  rtb_Selector1_jaut = rtCP_Constant_Value_k3nb[(sint32)((1023U *
    rtb_DataTypeConversion1_jrjz) >> 16)];
   ...
   *  Switch: '<S195>/Switch3'
   */
  rtb_Add_dots = (dt_Standardize_s16p15b0)(((sint16)((rtb_Switch3 *
    rtb_Selector1_hkbk) >> 14)) - ((sint16)((rtb_Switch3_eodk *
    rtb_Selector1_jaut) >> 14)));
   ...
   *  Switch: '<S195>/Switch3'
   */
  rtb_Add1_f4ha = (dt_Standardize_s16p15b0)(((sint16)((rtb_Switch3_eodk *
    rtb_Selector1_hkbk) >> 14)) + ((sint16)((rtb_Switch3 * rtb_Selector1_jaut) >>
    14)));
   ...
   *  Saturate: '<S131>/Saturation'
   */
  rtb_DataTypeConversion1_acqu = (((dt_Standardize_s16p15b0)
  ...
  if (rtb_DataTypeConversion_bgrg > rtb_DataTypeConversion1_acqu) {
    ...
    rtb_Gu16_facPLLCtlKp_MAP = look2_iu8s16lu32n16tu16_binlcse
      (busPhVltgGen_MedTaskIn.u8_tPCBTempSubs,
       ASW_PhVltgGen_DW.UnitDelay2_DSTATE, &Gu8_facPLLCtlKp_MAP_tPCBTempSubs_X[0],
  ...
  if (rtb_LogicalOperator_lnae) {
     ...
     */
    rtb_Switch1 = mul_ssu32_loSR(((sint16)(rtb_DataTypeConversion2_jzfl +
   ...
   *  Saturate: '<S131>/Saturation'
   */
  rtb_DataTypeConversion1_dd3w = (sint16)(((dt_Standardize_s16p15b0)
  ...
  if (rtb_LogicalOperator1) {
     ...
     *  Switch: '<S42>/Switch1'
     */
    rtb_Switch1_jfzu = (dt_Standardize_s16p15b0)((((tmp << 14) / 16777) * 3217) >>
      11);
  ...
  rtb_Add1_afic = (sint16)((((rtb_Switch1_jfzu * rtb_Saturation_pmq2) >> 16) +
    (((((131072 - rtb_Saturation_pmq2) >> 2) *
       ASW_PhVltgGen_DW.UnitDelay_DSTATE_fiwk) >> 15) << 1)) >> 1);
   ...
   *  Switch: '<S345>/Switch1'
   */
  rtb_Add1 = (dt_RadAng_u16r15b0)(rtb_Switch1_d0v1 + ((sint16)((((sint16)(((tmp >>
    1) * Gs16_tCtlVltgDelTi_C) >> 10)) * 20861) >> 14)));
   ...
   *  Sum: '<S363>/Add'
   */
  rtb_Selector1_prdr = rtCP_Constant1_Value_hq2b[(sint32)((1023U * ((uint16)
    (16384 - rtb_Add1))) >> 16)];
   ...
   *  Gain: '<S360>/Gain'
   */
  rtb_Selector1_blvz = rtCP_Constant_Value_lajm[(sint32)((1023U * rtb_Add1) >>
    16)];
   ...
   */
  rtb_Product = (dt_Standardize_u16p15b0)((((uint32)u0) *
    busPhVltgGen_MedTaskIn.u16_ampMaxNrmVltgAmp) >> 15);
  ...
  if (rtb_Compare_chmk) {
     ...
     */
    rtb_Switch1_gm5h = mul_ssu32_loSR(((sint16)(rtb_DataTypeConversion2_mweb +
   ...
   */
  if ((rtb_Product1_dtaz == 0) && (ASW_PhVltgGen_DW.UnitDelay_DSTATE_ksxz == 0))
  {
  ...
  if (rtb_Compare_chmk) {
     ...
     */
    rtb_Switch1_bxrl = mul_ssu32_loSR(((sint16)(rtb_DataTypeConversion2_bcnl +
  ...
  if ((rtb_Saturation_lsvn == 0) && (rtb_Saturation1_cdwd == 0)) {
    ...
    u0 = (uint16)((511U * ((uint16)((tmp << 15) / rtb_lb_genMaxInpMods_j3r1))) >>
                  15);
    if (u0 <= 511) {
    } else {
      u0 = 511U;
  ...
  if (rtb_Saturation1_iw11 == 0) {
     ...
     */
    /* SignalConversion generated from: '<S36>/u16_ampDycAmpNotZrIn' incorporates:
     *  Merge: '<S3>/Merge'
     *  MinMax: '<S3>/Min'
     *  Product: '<S36>/Divide'
     */
    busPhVltgGen_MedTaskOut.u16_ampDycAmp = (dt_DutyCycl_u16p15b0)((((uint32)u0)
      << 15) / rtb_Saturation1_iw11);
  ...
  if (rtb_Merge_kvzd == 0) {
     ...
     *  RelationalOperator: '<S90>/Relational Operator2'
     */
    if (((dt_Standardize_s16p15b0)rtb_Merge_kvzd) > ((dt_Standardize_s16p15b0)
      ...
      if (rtb_Saturation1_cdwd <= ((dt_Standardize_s16p15b0)rtb_Merge_kvzd)) {
         ...
         */
        if (rtb_Saturation1_cdwd >= ((dt_Standardize_s16p15b0)(-((sint16)
               rtb_Merge_kvzd)))) {
    ...
    /* Outputs for IfAction SubSystem: '<S94>/ias_AngleShiftNotApplied' incorporates:
    ...
    busPhVltgGen_MedTaskOut.u16_phiDaxQaxVltgAg = (dt_RadAng_u16r15b0)
      rtCP_lb_parAsinFunLkt_Value[(sint32)((2047U * ((uint16)(((sint16)((tmp <<
      14) / ((sint16)rtb_Merge_kvzd))) + 16384))) >> 14)];
    ...
    /* Outputs for IfAction SubSystem: '<S94>/ias_AngleShiftApplied' incorporates:
    ...
    busPhVltgGen_MedTaskOut.u16_phiDaxQaxVltgAg = (dt_RadAng_u16r15b0)(32768 -
      ...
      ((tmp << 14) / ((sint16)rtb_Merge_kvzd))) + 16384))) >> 14)]));
  ...
  if ((rtb_Add_dots == 0) && (rtb_Add1_f4ha == 0)) {
    ...
    u0 = (uint16)((511U * ((uint16)((tmp << 15) / rtb_lb_genMaxInpMods))) >> 15);
    if (u0 <= 511) {
    } else {
      u0 = 511U;
    }
   ...
   *  Sum: '<S49>/Add1'
   */
  busPhVltgGen_MedTaskOut.s16_phiOpnLpAgClsLpAgDvt = (dt_RadAng_s16r15b0)
    ASW_PhVltgGen_B.Add1;

  /* Sum: '<S41>/Add' incorporates:
   *  Inport: '<Root>/busPhVltgGen_MedTaskIn'
   *  Sum: '<S40>/Add2'
   */
  rtb_lb_inpDev = (sint16)(rtb_Add2 -
    busPhVltgGen_MedTaskIn.u16_phiModulActElecAg);
  ...
  busPhVltgGen_MedTaskOut.s16_nPredActElecSpd = (dt_Standardize_s16p15b0)
    ((((sint16)((((sint16)((tmp * u0) >> 13)) * 3217) >> 11)) >> 2) +
     rtb_Add1_afic);
  ...
  busPhVltgGen_MedTaskOut.s16_uModulDaxQaxVltg[0] = (dt_Standardize_s16p15b0)
    (((sint16)((rtb_Saturation3_pseh * rtb_Selector1_prdr) >> 14)) + ((sint16)
      ((rtb_Saturation4_ectf * rtb_Selector1_blvz) >> 14)));
  busPhVltgGen_MedTaskOut.s16_uModulDaxQaxVltg[1] = (dt_Standardize_s16p15b0)
    (((sint16)((rtb_Saturation4_ectf * rtb_Selector1_prdr) >> 14)) - ((sint16)
      ((rtb_Saturation3_pseh * rtb_Selector1_blvz) >> 14)));
  ...
  if (rtb_Saturation4_c3u0 < 0) {
    ...
    ASW_PhVltgGen_DW.UnitDelay2_DSTATE = (dt_Standardize_s16p15b0)
      (-rtb_Saturation4_c3u0);
  } else {
    /* Update for UnitDelay: '<S112>/Unit Delay2' */
...
void ASW_PhVltgGen_Init(void)
{
  ...
  (void) memset((void *)ASW_PhVltgGen_M, 0,
                sizeof(RT_MODEL_ASW_PhVltgGen));

  /* block I/O */
  (void) memset(((void *) &ASW_PhVltgGen_B), 0,
                sizeof(B_ASW_PhVltgGen));

  /* exported global signals */
  busPhVltgGen_MedTaskOut = ASW_PhVltgGen_rtZBUS_PHVLTGGEN_MED_TASK_OUT;

  /* states (dwork) */
  (void) memset((void *)&ASW_PhVltgGen_DW, 0,
                sizeof(DW_ASW_PhVltgGen));
