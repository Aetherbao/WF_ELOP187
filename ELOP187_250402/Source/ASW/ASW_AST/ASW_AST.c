...
#include "look1_iu8lu32n16ts16Ds32_binlcs.h"
...
void AST_SlwTask_Init(void)
{
  sint32 i;
  boolean rtb_lb_decrRatLimReq_dwiq;
  boolean rtb_lb_incrRatLimReq_mfp5;
  boolean rtb_lb_noRatLimReq_htpm;

  /* InitializeConditions for S-Function (sfix_udelay): '<S22>/Tapped Delay' */
  for (i = 0; i < 19; i++) {
    ASW_AST_DW.TappedDelay_DWORK1[i] = 0;
  }

  /* End of InitializeConditions for S-Function (sfix_udelay): '<S22>/Tapped Delay' */

  /* InitializeConditions for S-Function (sfix_udelay): '<S73>/Tapped Delay' */
  memset(&ASW_AST_DW.TappedDelay_DWORK1_msrl[0], 0, 39U * (sizeof(sint16)));

  /* SystemInitialize for Chart: '<S164>/sfc_SysSTM' */
  ASW_AST_DW.is_NORMAL = IN_NO_ACTIVE_CHILD;
  ASW_AST_DW.is_active_c2_ASW_AST = 0U;
  ASW_AST_DW.is_c2_ASW_AST = IN_NO_ACTIVE_CHILD;
  ASW_AST_DW.u16_ctSysStInitWaitCnt = 0U;

  /* SystemInitialize for Chart: '<S78>/sfc_OpnLpRefElecSpdConf' */
  ASW_AST_DW.is_active_c1_ASW_AST = 0U;
  ASW_AST_DW.is_c1_ASW_AST = IN_NO_ACTIVE_CHILD;
  ASW_AST_DW.u16_ctAlgnStEndCnt = 0U;
  ASW_AST_B.s16_nOpnLpRefElecSpd = 0;

  /* SystemInitialize for Chart: '<S92>/Chart' */
  ASW_AST_Chart_Init(&rtb_lb_noRatLimReq_htpm, &rtb_lb_incrRatLimReq_mfp5,
                     &rtb_lb_decrRatLimReq_dwiq);

  /* SystemInitialize for Chart: '<S93>/Chart' */
  ASW_AST_Chart_Init(&rtb_lb_noRatLimReq_htpm, &rtb_lb_incrRatLimReq_mfp5,
                     &rtb_lb_decrRatLimReq_dwiq);

  /* SystemInitialize for Chart: '<S75>/sfc_PhiModeStateMachine' */
  ASW_AST_DW.is_active_c11_ASW_AST = 0U;
  ASW_AST_DW.is_c11_ASW_AST = IN_NO_ACTIVE_CHILD;

  /* SystemInitialize for Enabled SubSystem: '<S133>/ens_SensAgCalibNeed' */
  /* SystemInitialize for Chart: '<S137>/sfc_SensAgCalibSTM' */
  ASW_AST_DW.is_active_c3_ASW_AST = 0U;
  ASW_AST_DW.is_c3_ASW_AST = IN_NO_ACTIVE_CHILD;
  ...
  ASW_AST_B.u16_phiSensElecAgDvt = 0U;
  busAST_SlwTaskOut.bol_flgPosSCDCalibPermFail = false;
  ASW_AST_B.u16_phiAlPhElecAg = 0U;
  ASW_AST_B.u16_phiBePhElecAg = 0U;

  /* SystemInitialize for Chart: '<S139>/Chart' */
  ASW_AST_Chart_Init(&rtb_lb_noRatLimReq_htpm, &rtb_lb_incrRatLimReq_mfp5,
                     &rtb_lb_decrRatLimReq_dwiq);

  /* End of SystemInitialize for SubSystem: '<S133>/ens_SensAgCalibNeed' */
}
...
/* Model step function */
void ASW_AST_step(void)
{
  if (ASW_AST_M->Timing.TaskCounters.TID[1] == 0) {
    /* Outputs for Atomic SubSystem: '<Root>/AST_SlwTask' */
    AST_SlwTask();

    /* End of Outputs for SubSystem: '<Root>/AST_SlwTask' */
  }
...
void ASW_AST_Init(void)
{
  /* Registration code */

  /* initialize real-time model */
  (void) memset((void *)ASW_AST_M, 0,
                sizeof(RT_MODEL_ASW_AST));

  /* block I/O */
  (void) memset(((void *) &ASW_AST_B), 0,
                sizeof(B_ASW_AST));
  ...
  busAST_SlwTaskOut = ASW_AST_rtZBUS_AST_SLW_TASK_OUT;

  /* states (dwork) */
  (void) memset((void *)&ASW_AST_DW, 0,
                sizeof(DW_ASW_AST));

  /* external inputs */
  busAST_SlwTaskIn = ASW_AST_rtZBUS_AST_SLW_TASK_IN;

  /* SystemInitialize for Atomic SubSystem: '<Root>/AST_SlwTask' */
  AST_SlwTask_Init();

  /* End of SystemInitialize for SubSystem: '<Root>/AST_SlwTask' */
}
